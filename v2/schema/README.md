  ...
  "$defs": {
    ...
    "DiscussionEntry": {
      "properties": {
        ...
        "has_media": {
          "default": false,
          "description": "True if this discussion message included an image/video/audio/document attachment in the original chat. Only tracked for hint and answer_reveal roles — reaction GIFs and memes in chat/attempt/confirmation entries are intentionally excluded.",
          "title": "Has Media",
          "type": "boolean"
        },
        "media": {
